...
:: Android packaging
set AND_CERT_NAME="EarthBeat"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\EarthBeat.p12
...
set IOS_PROVISION=cert\EarthBeat.mobileprovision
...
set APP_ID=air.EarthBeat

:: Output packages
set DIST_PATH=dist
set DIST_NAME=EarthBeat
